...
password = '12345'
db_config_param = 'DRIVER={ODBC Driver 17 for SQL Server};SERVER=192.168.1.3:1433;DATABASE=%(database)s;UID=%(login)s;PWD=%(password)s' % {'database': database, 'login': login, 'password': password}
